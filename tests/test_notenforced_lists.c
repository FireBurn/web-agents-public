...
static void test_ip6() {
    ...
    ipv6_compare(28, "2001:20::/28"); // ORCHIDv2 (Overlay Routable Cryptographic Hash Identifiers). inet_net_pton says
                                      // they are invalid
