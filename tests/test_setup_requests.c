...
#define TEST_TOKEN_VALUE                                                                                               \
    "AQIC5wM2LY4Sfcyro187TdQ7LJIs373_tJP4Lb2VXBv-Qoc.*AAJTSQACMDEAAlNLABM5MjExNjg2Nzk3Mjg3MjI4MDA2*"
...
static am_status_t am_get_SAML_post_url(struct am_request *request) {
    ...
    char *saml = "<x xmlns:saml=\"http:/w3c.org/nonsense#id\">"
