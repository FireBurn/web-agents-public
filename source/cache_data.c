...
enum { UINT64_TYPE = 0, UINT32_TYPE, SINT32_TYPE, STR32_TYPE, ARRAY32_TYPE, MAP32_TYPE };
...
static int cache_object_read_s32(struct cache_object_ctx *ctx, int32_t *val) {
    ...
    if (cache_object_read(ctx, &obj) == 0 && obj.type == SINT32_TYPE) {
        *val = obj.obj.s32;
        return 0;
    }
    return -1;
...
static int cache_object_read_u64(struct cache_object_ctx *ctx, uint64_t *val) {
    struct cache_object obj;
    if (cache_object_read(ctx, &obj) == 0 && obj.type == UINT64_TYPE) {
        *val = obj.obj.u64;
        return 0;
    }
    return -1;
...
static int cache_object_read_array(struct cache_object_ctx *ctx, uint32_t *size) {
    struct cache_object obj;
    if (cache_object_read(ctx, &obj) == 0 && obj.type == ARRAY32_TYPE) {
...
static int cache_object_read_map(struct cache_object_ctx *ctx, uint32_t *size) {
    struct cache_object obj;
    if (cache_object_read(ctx, &obj) == 0 && obj.type == MAP32_TYPE) {
