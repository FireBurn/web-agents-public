...
/**
 * This is our representation of "boolean".  Try to avoid boolean itself as
 * although supposed to be part of the language for some time now, it seems to
 * be a grey area.  This is needed by log.h.
 */
typedef enum { AM_FALSE = 0, AM_TRUE } am_bool_t;
...
typedef enum { AM_OK = 0, AM_FAIL, AM_RETRY, AM_QUIT } am_return_t;
